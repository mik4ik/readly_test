...
gulp.task('sass', function(){ // Создаем таск Sass
	return gulp.src('app/sass/styles.scss') // Берем источник
        .pipe(sassGlob())
...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки
		...
		'app/libs/templayed/templayed.js', // Берем templayed
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts'], function() {
	...
	gulp.watch('app/libs/**/*.js', browserSync.reload);   // Наблюдение за JS файлами в папке libs
});
